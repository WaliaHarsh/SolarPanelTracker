...
/** \brief Gets BME280Pressure
 *
 * \param void
 * \return Double value for p_acc
 * \author Harshit Walia, Sahil Sahil
 * \date 24JAN2019 
 */
...
/** \brief Gets BME280Temperature
 *
 * \param void
 * \return Double value for output
 * \author Harshit Walia, Sahil Sahil
 * \date 24JAN2019 
 */
